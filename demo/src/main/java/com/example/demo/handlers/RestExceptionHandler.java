...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleConstraintViolationException(
        ...
        Set<ConstraintViolation<?>> violations = ex.getConstraintViolations();//lista de validari care au esuat
        List<String> details = violations.stream()
                .map(v -> v.getPropertyPath() + ": " + v.getMessage())
                .toList();//numele campului invalid si msj de eroare
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        //ObjectError
        //Reprezintă o eroare generică (poate fi pe un câmp sau la nivel de obiect întreg)
        ...
        HttpStatus httpStatus = HttpStatus.valueOf(status.value());//status vine ca httpstatuscode
        var body = new ExceptionHandlerResponseDTO(
                "Validation failed",
    ...
    protected ResponseEntity<Object> handleCustomExceptions(CustomException ex, WebRequest request) {
        //PT ORICE CLASA CARE MOSTENESTE CUSTOMEXCEPTION
        var body = new ExceptionHandlerResponseDTO(
                ex.getResource(),
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        //CAND NU EXISTA URL UL RESPECTIV
        HttpStatus httpStatus = HttpStatus.valueOf(status.value());
        var body = new ExceptionHandlerResponseDTO(
                "No handler found",
                httpStatus.getReasonPhrase(),
    ...
    public ResponseEntity<Object> handleUnexpected(Exception ex, WebRequest request) {
        //prinde orice excepție neașteptată care nu a fost prinsă de celelalte metode.
